	...
	return (
		<>
			...
			<div className="bg-[#FFFFF] py-20">
				<div className="container font-epilogue">
					<h2 className="font-semibold mb-5 text-center leading-tight">
						Explore Service
					</h2>
			...
			{/* About*/}
			<div className="py-20">
				<div className="container font-epilogue flex sm:flex-col md:flex-row gap-10 items-center">
					<div className="flex-1 ">
						<img src={about} alt="" />
					</div>
					<div className="flex-1 ">
						<h6 className="mt-5">ABOUT</h6>
						<h2 className="font-semibold mb-5 leading-tight">
			...
			<div className="py-20">
				<div className="container">
					<h2 className="font-epilogue font-semibold mb-5 text-center leading-tight">
						Discover Our Work
					</h2>
					<p className="text-lg mb-10 text-center">
						Web designer is responsible for creating the <br /> design and
						layout of a website.
					</p>
				</div>
				<div className="bg-primary text-white py-28">
					<div className="container lg:px-20 flex lg:flex-row sm:px-0 sm:flex-col items-center justify-center">
						<div className="flex-1 sm:mb-10 px-32">
							<h6>User Interface</h6>
							<h3 className="font-semibold leading-tight mb-5">
								Creative Agency <br />& Portfolio
							</h3>
							<p className="text-base mb-5">
								Web designers plan, create and code internet <br /> sites and
								web pages, text with sounds.
							</p>
						</div>
						<div className="flex-1 flex justify-center items-center">
							<img src={agency} alt="" className="w-[30rem] h-[25rem]" />
						</div>
					</div>
				</div>
			</div>
			...
			<div className="bg-[#F3F7F5] pb-20">
				<div className="container">
					<div className="flex flex-col justify-center items-center">
						...
						<div className="flex lg:px-[15rem]">
